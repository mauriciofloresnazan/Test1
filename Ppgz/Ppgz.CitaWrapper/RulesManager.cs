...
namespace Ppgz.CitaWrapper
{
    public static class RulesManager
    {
        ...
        internal static List<DayOfWeek> GetDiasDeSemana()
        {
        ...
        /// </summary>
        public static bool ValidarRegla4(DateTime fechaCita)
        {
            //TODO CALCULAR CUANDO ESTOY EN LA ULTIMA DESMANA DEL AÑO
        ...
        /// <summary>
        /// 5.	El proveedor solo tiene las horas comprendidas de 7:am a 8pm de lunes a viernes para seleccionar el horario de entrega
        /// </summary>
        public static bool ValidarRegla5()
        {
            throw new NotImplementedException();
        }
        /// <summary>

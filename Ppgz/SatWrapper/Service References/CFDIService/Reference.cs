...
namespace SatWrapper.CFDIService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="CFDIService.IConsultaCFDIService")]
    public interface IConsultaCFDIService {
        ...
        SatWrapper.CFDIService.Acuse Consulta(string expresionImpresa);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IConsultaCFDIService/Consulta", ReplyAction="http://tempuri.org/IConsultaCFDIService/ConsultaResponse")]
        System.Threading.Tasks.Task<SatWrapper.CFDIService.Acuse> ConsultaAsync(string expresionImpresa);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IConsultaCFDIServiceChannel : SatWrapper.CFDIService.IConsultaCFDIService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConsultaCFDIServiceClient : System.ServiceModel.ClientBase<SatWrapper.CFDIService.IConsultaCFDIService>, SatWrapper.CFDIService.IConsultaCFDIService {
        ...
        public SatWrapper.CFDIService.Acuse Consulta(string expresionImpresa) {
            return base.Channel.Consulta(expresionImpresa);
        }
        
        public System.Threading.Tasks.Task<SatWrapper.CFDIService.Acuse> ConsultaAsync(string expresionImpresa) {
